...
public class NotificationText {
    public static List<String> mainNotificationTitleGerman = Arrays.asList(
            "Vergiss mich nicht!",
    ...
    public static List<String> notificationHintsListGerman = Arrays.asList(
            "Der RechenMax wurde nur von einer einzigen Person erschaffen.",
            "Du kannst fast alles in den Einstellungen anpassen.",
            "Du erhältst eine Anleitung, indem du auf das Fragezeichen in den Einstellungen klickst.",
            "Der Name der App stammt vom Onkel des Erfinders.",
            "Die Android-Version des RechenMax wurde etwa am 01.10.23 zum Leben erweckt.",
            "Es gibt auch eine Windows-Version vom RechenMax.",
            "Du kannst mehr Funktionen nutzen, indem du oben links auf den Knopf drückst.",
            "Der vereinfachte Berechnungsmodus in den Einstellungen kann vieles erleichtern.",
            "Der RechenMax hat am 01.10.2023 Geburtstag.",
            "Der Taschenrechner war ursprünglich nur für Windows gedacht.",
            ...
            "Der RechenMax war das erste bedeutende Projekt des Entwicklers.",
            "Deine Berechnungen sind sicher gespeichert.",
            "Du kannst die Farbe des Taschenrechners in den Einstellungen anpassen.",
            "Der RechenMax kann mehr als nur einfache Mathematik!",
            "Im Hilfebereich in den Einstellungen findest du nützliche Hinweise und Tipps.",
    ...
    public static List<String> notificationHintsListEnglish = Arrays.asList(
            "RechenMax was created by only one person.",
            "You can customize almost everything in the settings.",
            "You'll receive a guide by clicking on the question mark in the settings.",
            "The app's name comes from the inventor's uncle.",
            "The Android version of RechenMax came to life around 01.10.23.",
            "There's also a Windows version of RechenMax.",
            "You can access more functions by pressing the button in the top left corner.",
            "The simplified calculation mode in the settings can make things easier.",
            "RechenMax's birthday is on 01.10.2023.",
            "The calculator was originally intended for Windows only.",
            "The calculator was developed in Germany.",
            "42 is the answer to the entire universe.",
            "In RechenMax, there are additional functions besides the basic arithmetic operations.",
            "The calculator was created using Java.",
            "RechenMax is regularly updated.",
            "Work on the calculator is constantly ongoing.",
            "Hope you like RechenMax.",
            "RechenMax was the developer's first significant project.",
            "Your calculations are securely saved.",
            "You can customize the color of the calculator in the settings.",
            "RechenMax can do more than just simple mathematics!",
            "In the help section in the settings, you'll find useful hints and tips.",
    ...
    public static List<String> mainNotificationTitleFrench = Arrays.asList(
            "N'oublie pas de moi!",
    ...
    public static List<String> notificationHintsListFrench = Arrays.asList(
            "RechenMax a été créé par une seule personne.",
            "Vous pouvez personnaliser presque tout dans les paramètres.",
            "Vous recevrez un guide en cliquant sur le point d'interrogation dans les paramètres.",
            "Le nom de l'application vient de l'oncle de l'inventeur.",
            "La version Android de RechenMax est apparue vers le 01.10.23.",
            "Il existe également une version Windows de RechenMax.",
            "Le mode de calcul simplifié dans les paramètres peut faciliter les choses.",
            "L'anniversaire de RechenMax est le 01.10.2023.",
            "La calculatrice était initialement destinée à Windows uniquement.",
            "La calculatrice a été développée en Allemagne.",
            "42 est la réponse à l'univers entier.",
            "La calculatrice a été créée en utilisant Java.",
            "RechenMax est régulièrement mis à jour.",
            "Le travail sur la calculatrice est en cours de développement constant.",
            "J'espère que vous aimerez RechenMax.",
            "RechenMax était le premier projet significatif du développeur.",
            "Vos calculs sont enregistrés en toute sécurité.",
            "Vous pouvez personnaliser la couleur de la calculatrice dans les paramètres.",
            "RechenMax peut faire plus que de simples mathématiques !",
            "Dans la section d'aide dans les paramètres, vous trouverez des conseils utiles.",
    ...
    public static List<String> notificationHintsListSpanish = Arrays.asList(
            "RechenMax fue creado solo por una persona.",
            "Puedes personalizar casi todo en la configuración.",
            "Recibe instrucciones haciendo clic en el signo de interrogación en la configuración.",
            "El nombre de la aplicación proviene del tío del inventor.",
            "La versión de Android de RechenMax cobró vida alrededor del 01.10.23.",
            "También hay una versión de Windows de RechenMax.",
            "Puedes acceder a más funciones presionando el botón en la esquina superior izquierda.",
            "El modo de cálculo simplificado en la configuración puede hacer muchas cosas más fáciles.",
            "RechenMax cumple años el 01.10.2023.",
            "Originalmente, la calculadora estaba destinada solo para Windows.",
            "La calculadora fue desarrollada en Alemania.",
            "42 es la respuesta a todo el universo.",
            "En RechenMax, además de las operaciones básicas, hay otras funciones.",
            "La calculadora fue creada utilizando Java.",
            "RechenMax se actualiza regularmente.",
            "El trabajo en la calculadora está en curso constante.",
            "Espero que te guste RechenMax.",
            "RechenMax fue el primer proyecto importante del desarrollador.",
            "Tus cálculos están guardados de forma segura.",
            "Puedes personalizar el color de la calculadora en la configuración.",
            "¡RechenMax puede hacer mucho más que solo matemáticas básicas!",
            "En la sección de ayuda en la configuración, encontrarás consejos útiles.",
